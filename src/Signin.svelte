<script>
    let client_id="255830753763-2dhccvuvrd6955g7m1pkipjok8srf1jk.apps.googleusercontent.com";
...
<main>
    ...
    <div id="g_id_onload" data-client_id={client_id} data-callback="handleGoogleCredential" data-auto_prompt="false"></div>
    <div class="g_id_signin" data-type="standard" data-size="large" data-theme="outline" data-text="sign_in_with"
        data-shape="circle" data-width="400" data-logo_alignment="left"></div>
</main>
